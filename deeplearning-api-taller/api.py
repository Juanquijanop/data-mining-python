...
async def predict_crime(data: CrimePredictionInput):
    ...
    required_columns = set(model.feature_names_in_)  # Requiere sklearn 0.24 o superior
    missing_columns = required_columns - set(input_data.columns)
    for column in missing_columns:
        input_data[column] = 0
    
    # Asegurarse de que las columnas de input_data estén en el mismo orden que el modelo
